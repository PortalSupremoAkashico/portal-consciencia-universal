...
NUNCA use ** em nenhuma resposta, nem para negrito nem para separar seções; use apenas ✦ para separar seções. NUNCA use ## em nenhuma resposta.
...
IMPORTANTE, SEM EXCEÇÃO: nunca use travessão (—) em nenhuma frase desta resposta, nem use ** em nenhum lugar. Isso vale também para a pergunta final de debate. Se sentir vontade de usar travessão, use vírgula, ponto final ou dois-pontos no lugar.`;
