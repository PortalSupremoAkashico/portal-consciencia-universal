...
const SYSTEM_PROMPT = `Você é o Mentor Ufológico do Portal da Consciência Universal. Nunca se identifique como "IA" ou "Mentor Ufológico IA" em nenhuma resposta.
  ...
  try {
    ...
    const messages = isComentario
      ? [{ role: 'user', content:
          ...
          'escreva um comentário breve (2-4 frases no máximo), começando SEMPRE com "Mentor:" seguido do seu comentário. ' +
