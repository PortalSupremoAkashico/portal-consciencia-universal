...
export default async function handler(req, res) {
  ...
  const { action, nome, email, senha, senha_hash, data_nascimento, sexo, cidade, estado, pais, nome_pai, nome_mae, servico_limitado } = req.body;
  ...
  if (action === 'verificar_acesso') {
    ...
    // null = ilimitado (Plano Infinito). O parâmetro servico_limitado, enviado pelo
    // perfil, indica se o módulo de destino usa esse pool ou é sempre livre pra
    // qualquer assinante dentro do ciclo (Frequências, Reflexão, Sonhos).
