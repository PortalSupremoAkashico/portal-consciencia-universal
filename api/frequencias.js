...
export default async function handler(req, res) {
  ...
  if (action === 'gerar') {
    ...
    const acesso = await verificarAcesso(email, 'uso_frequencia');
    if (!acesso.permitido) {
...
Responda APENAS em JSON válido, sem markdown, sem aspas tipográficas, sem quebras de linha dentro dos valores — use \\n para separar parágrafos:
{
  ...
  "leitura": {
    ...
    try {
      ...
      // Cobra (debita crédito ou soma no pool do plano) agora que a IA confirmou
      // e a resposta foi interpretada com sucesso.
