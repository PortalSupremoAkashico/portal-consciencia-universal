...
${baseSystemPrompt}`;
    ...
    const resp = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      headers: {
        ...
        'anthropic-beta': 'prompt-caching-2024-07-31'  // ← necessário para ativar o cache
      },
      body: JSON.stringify({
        model: 'claude-sonnet-4-6',
        max_tokens: 20000,
        // Prompt Caching: system prompt dividido em parte estática (cacheada) e dinâmica
        // Cache dura 5 minutos — reduz custo do input em ~85% para consultas frequentes
        system: [
          {
            type: 'text',
            text: fullSystemPrompt,
            cache_control: { type: 'ephemeral' }  // ← cacheia os ~40k tokens de system prompts
          }
        ],
