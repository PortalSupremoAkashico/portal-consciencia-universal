...
export default async function handler(req, res) {
  ...
  try {
    const { name, birthdate, theme, state, question, level, cosmicMode, gender, email,
            ...
            cidade, estado_nasc, pais, nome_pai, nome_mae, hora_nascimento } = req.body;
...
${bioContext ? `DADOS BIOGRÁFICOS COMPLEMENTARES (use com sutileza — no máximo uma vez, apenas onde agregar profundidade real à leitura; NUNCA liste ou mencione mecanicamente todos os dados, e NUNCA cite nome dos pais ou local de nascimento de forma repetida ao longo do texto):${bioContext}` : ''}
TEMA: ${theme}
