...
Responda APENAS em JSON válido com estas 6 chaves:
{
  ...
  "action": "..."
    ...
    // ═══════════════════════════════════════════════
    // Todas as 9 perspectivas disponíveis — seleção totalmente aleatória
    const todasPerspectivas = ['espirita', 'cristao', 'cientifico', 'historico', 'futurista', 'akashico', 'egipcio', 'oriental', 'xamanico'];
    const selecionadas = todasPerspectivas.sort(() => Math.random() - 0.5).slice(0, 5);
    const [primary, secondary, spiritual1, spiritual2, spiritual3] = selecionadas;
