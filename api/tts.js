  ...
  try {
    ...
    const response = await fetch('https://api.openai.com/v1/audio/speech', {
      ...
      body: JSON.stringify({
        ...
        voice: 'onyx',
        input: cleanText,
        instructions: 'Fale exclusivamente em português do Brasil. Use sotaque, entonação e pronúncia brasileiros naturais em todo momento. Nunca use sotaque de Portugal.',
        speed: speed || 0.92,
        response_format: 'mp3'
      })
    });
