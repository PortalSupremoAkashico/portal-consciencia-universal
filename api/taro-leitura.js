...
export default async function handler(req, res) {
  ...
  const prompt = `Você é um Tarólogo de elite, profundo conhecedor do simbolismo dos Arcanos e da linguagem das cartas. Leitura profunda e altamente personalizada para ${firstName}.
...
§1: O simbolismo desta carta — o que ela carrega energeticamente, seu arquétipo e sua vibração específica
...
§3: A mensagem desta carta diretamente para você (${firstName}) — orientação amorosa, profunda e acionável

SINTESE: 3 parágrafos — (1) padrão geral que emerge do conjunto de TODAS as cartas; (2) verdade central que o Tarô revela para ${firstName} sobre "${perguntaReal}"; (3) caminho indicado com confiança e clareza
