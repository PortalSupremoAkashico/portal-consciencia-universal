...
// Ajuste os nomes e valores reais dos serviços/planos recorrentes aqui
const PRODUTOS = {
  mentoria:     { valor: 197.00, frequencia: 1,  frequenciaTipo: 'months', destino: '/mentoria' },
  plano_mensal: { valor: 97.00,  frequencia: 1,  frequenciaTipo: 'months', destino: '/consulta' },
  plano_anual:  { valor: 797.00, frequencia: 12, frequenciaTipo: 'months', destino: '/consulta' }
};
